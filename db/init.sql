...
INSERT INTO users (username, email, password_hash, role) VALUES
  ('alice', 'alice@lab.local', '$2b$10$a9GRZfD2XTeNduQkAWR3yeaScqobO6rSNHEnUUbH7OIYS1crHBySC', 'member'),
  ('bob',   'bob@lab.local',   '$2b$10$79Yh14EI0TsaHJtlE8P1HOAC1mgEhc83Hdt0fsulIEfvLi/bDLqMC',   'member'),
  ('admin', 'admin@lab.local', '$2b$10$3zHKtqfd86QccW9Woeq/zOv/G9c3lnoHneARDAdZsHVQ9HPVHacsm','admin')
